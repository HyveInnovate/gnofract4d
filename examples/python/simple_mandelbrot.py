#!/usr/bin/env python3
# ignore pylint invalid-name, wrong-import-position
...
# 8th create a color map to convert point fates (iterations
# needed to determine if the point scapes) into colors
...
# 9th create an image: this one will hold the final
# result and provide utilities to save it into a file
...
if message_handler.status_list[-1] == 0:
    image_wrapper.save("examples/output/mandelbrot.png")
else:
